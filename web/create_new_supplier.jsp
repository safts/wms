...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
	<meta charset="utf-8" />
	<title>Create New Product Supplier</title>
		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Create New Product Supplier</a>
					</li>
					...
					<h1>Create New Product Supplier
					    <span class="my_back_button"><button class="btn btn-primary"><span title=".icon32  .icon-white  .icon-arrowthick-w " class="icon icon-white icon-arrowthick-w"></span><span>Back to "Manage Product Suppliers"</span></button></span>
				    ...
				    <!--<div class="span6">-->
				    <form class="form-horizontal" action="suppl_add" method="post" id="supplier_form">
					...
					<fieldset style="float:left;">
						...
						<div class="controls">
						    <input id="address" class="input-xlarge focused" type="text" name="address" autocomplete="off" maxlength="45" />
						    <span style="color:red;">*</span>
						...
						<div class="controls">
						    <input id="email" class="input-xlarge focused" type="text" name="email" autocomplete="off" maxlength="45"/>
						    <span style="color:red;">*</span>
						...
						<div class="controls">
						    <input id="phone" class="input-xlarge focused" type="text" name="phone_n" autocomplete="off" maxlength="20"/>
						    <span style="color:red;">*</span>
						...
						<div class="controls">
						    <input id="nin" class="input-xlarge focused" type="text" name="nin" autocomplete="off" maxlength="25" />
						    <span style="color:red;">*</span>
						    <span id="ninspan"></span>
						</div>
					    </div>

					</fieldset>
					<fieldset>
					    <div class="span6" style="padding-top:10px; padding-bottom:10px;margin-top:14%;">
						<br/>
						<button class="btn btn-large btn-info" type="submit" style="box-shadow: 0px 2px 5px 2px grey;">Insert Product Supplier</button>
					    </div>
					</fieldset>
				    </form>	
	...
	<script src="js/validate_new_supplier.js"></script>
