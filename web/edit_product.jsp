		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Edit Product</a>
					</li>
				    </ul>
				    ...
				    <!-- <div class="row-fluid ">       -->	
				    <!--<div class="span6">-->
				    <form class="form-horizontal" action="prod_edit" method="post">
					<%@ page import="entities.Product" %>
					<%@ page import="DBcomm.ProdComm" %>

					<% Product p = ProdComm.getProducts(request.getParameter("prod_sn")).get(0);%>
					<!--fieldset for personal information--> 
					<fieldset style="float:left;">
					    <legend class=" my_legend">Main Product Information</legend>
					    <!--Name field-->
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Name</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="name" value="<%=p.getName()%>" readonly="readonly" />
						</div>
					    </div>
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Serial Number</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name ="serial_n" value="<%=p.getSerialN()%>" readonly="readonly"/>
						</div>
					    </div>
					    <!--Surname field-->
					    <div class="control-group">
						...
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="description" value="<%=p.getDescr()%>" autofocus />
						</div>
					    </div>
					    <div class="control-group">
						<label class="control-label" for="selectError1">Move from Warehouse</label>
						<div class="controls">
						    <select class="input-xlarge" id="selectError1" name ="old_wh_sel" data-rel="chosen" style="width:88%;">
							...
							<%@ page import="DBcomm.Pr_H_WhComm" %>
								<% for (Warehouse h : Pr_H_WhComm.getWh(request.getParameter("prod_sn"))) {
					    ...
					    <div class="control-group">
						<label class="control-label" for="selectError3">to Warehouse</label>
						<div class="controls">
						    <select class="input-xlarge" id="selectError3" name ="wh_sel" data-rel="chosen" style="width:88%;">
						...
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" name ="amount" type="text" value="12"/>
						</div>
					    </div>-->
					    <div class="control-group">
					...
					<fieldset style="float:right; margin-right:5%; clear:right;">
					    <legend class=" my_legend">More Product Information </legend>
					    <div class="control-group">
						<label class="control-label" for="selectError2">Change Supplier</label>
						<div class="controls">
						    <select class="input-xlarge" id="selectError2" name ="suppl_sel" data-rel="chosen" style="width:88%;">
							<option disabled="disabled" selected="">none</option>
						...
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name ="price" value="" />
						</div>
					    </div>
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Dimensions</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="dimensions" value="<%=p.getDim()%>" />
						</div>
					    </div>
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Weight</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="weight" value="<%=p.getWeight()%>" />
						</div>
					    </div>
					</fieldset>
					<fieldset style=" float:left; display:block;  clear:both;">
					    <div style="padding-top:10px; padding-bottom:10px; margin-left: 75%;">
						<br/>
						<button class="btn btn-large btn-primary" type="submit" style="box-shadow: 0px 2px 5px 2px grey;">Submit Changes </button>
					    </div>
					</fieldset>
				    </form>	
				    <!--</div> -->    <!--/row -->   
