		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">View User</a>
					</li>
					...
					<% User c = UserComm.getConfUsers((String) request.getParameter("username")).get(0);%>
					<div class="box span6">
					    <div class="box-header well" data-original-title>
						...
						<table class="table table-striped">  
						    ...
						    <tr>
							<td class="my_table_headers">Username :</td>
							<td ><%=c.getUsername()%></td>
						    ...
						    <tr>
							<td class="my_table_headers">Surname :</td>
							<td ><%=c.getSurname()%></td>
						    ...
						    <tr>
							<td class="my_table_headers">Status :</td>
							<td >
							    <span class="label label-success">Active</span>
							</td>                                        
						    </tr>
						    <tr>
							<td class="my_table_headers">Sign up Date :</td>
							<td ><%=c.getSignupDate()%></td>   
						    </tr>
						    <tr>
							<td class="my_table_headers">User Role :</td>
							<td ><%=c.getUserRole()%></td>                                        
						    </tr>
						    <tr>
							<td class="my_table_headers">Last Logged in :</td>
							<td ><%=c.getLastloggedin()%></td>                                        
						    </tr>                                
					...
					%>    
					<jsp:include page='<%="change_user_role.jsp"%>'/>
