			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<div class="box span12">
					    ...
					    <div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable " id="users">
						    <thead>
							<tr>
							    <th>Username</th>
							...
							<%  int counter = 0;
								for (User c : UserComm.getPendUsers(null)) {
									counter++;
							...
							<tr>
							    ...
							    <td class="center">
								<form style='display:inline' action="view_pending_user.jsp" method="post">
								...
								<form style="display:inline" action="user_rem" id ="<%=form_id%>" method="post">
								    <input type="hidden" name="username" value="<%=c.getUsername()%>" />
					...
					<div class="box span12">
						...
						<table class="table table-striped table-bordered bootstrap-datatable" id="users1" >
							...
							<%@ page import="DBcomm.UserComm" %>
							<%  int temp = counter + 1;
								for (User c : UserComm.getConfUsers(null)) {
									counter++;
									String button_id = Integer.toString(counter);
									String form_id = "form" + button_id;
							%>
							<tr>
							    ...
							    <td class="center"><%=c.getUserRole()%></td>
								
							    <td class="center">
								<form style='display:inline' action="view_user.jsp" method="post">
								    <input type="hidden" name="username" value="<%=c.getUsername()%>" />
