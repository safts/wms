...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
	<meta charset="utf-8" />
	<title>Manage Product Suppliers</title>
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<div class="box span12">
					    ...
					    <div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable" id="bla">
						    <thead>
							<tr>
							    <th>Name</th>
							    <th>Address</th>
							...
							<tr>
							    ...
							    <td class="center"><%=s.getPhone_number()%></td>
							    <td class="center"><%=s.getN_i_n()%></td>
							    <td class="center">
								<form style='display:inline' action="suppl_view" method="post">
								    <input type="hidden" name="name" value="<%=s.getName()%>" />
								    <%if (Integer.parseInt(suppl_perm) > 0) {
								...
								<form style='display:inline' action="edit_supplier.jsp" method="post">
								    <input type="hidden" name="name" value="<%=s.getName()%>" />
								    <%if (Integer.parseInt(suppl_perm) == 2) {
								...
								<form style='display:inline' action="suppl_rem" id ="<%=form_id%>" method="post" >
								    <input type="hidden" name="name" value="<%=s.getName()%>" />
								    <%if (Integer.parseInt(suppl_perm) == 2) {
						...
						<div style="float:left;">
						    <a class="btn btn-danger" href="create_new_supplier.jsp" style="padding:6px 10px 6px 10px;">
							<span class="icon icon-white icon-add"></span> 
							<span>Create New Product Supplier</span>
						    </a>
						</div>
						<%}%>
						<br/>
