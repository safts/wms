		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Edit Role Permissions</a>
					</li>
				    ...
				    <!--<div class="span6">-->
				    <form class="form-horizontal" action="sys_role_edit" method="post">
					<%@ page import="entities.UsrRole" %>
					<%@ page import="DBcomm.UsrRoleComm" %>

					<% UsrRole r = UsrRoleComm.getUserRoles(request.getParameter("sys_role")).get(0);%>
					<!--fieldset for personal information--> 
					<fieldset style="float:left;">
					    <legend class=" my_legend">Edit Permissions</legend>
					    <!--Name field-->
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Role Description</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" value="<%=r.getDescription()%>" name="description"  readonly="readonly"autofocus/>
						    <input type="hidden" name="old_description" value="<%=r.getDescription()%>" />
						</div>
					    </div>
					    <div class="control-group">
						...
						<div class="controls">
						    <select  name ="wh_sel" data-rel="chosen">
						...
						<div class="controls">
						    <select  name ="suppl_sel" data-rel="chosen" >
							<option value="1" selected="selected">Read</option>
							<option value="2">Edit</option>
							<option value="0">None</option>
						    </select>
						...
						<div class="controls">
						    <select   name ="pr_sel" data-rel="chosen" >
							<option value="1" selected="selected">Read</option>
							<option value="2">Edit</option>
							<option value="0">None</option>
						    </select>
						...
						<div class="controls">
						    <select  name ="rl_sel" data-rel="chosen" >
							<option value="1" selected="selected">Read</option>
							<option value="2">Edit</option>
							<option value="0">None</option>
						    </select>
						...
						<div class="controls">
						    <select  name ="usr_sel" data-rel="chosen" >
							<option value="1" selected="selected">Read</option>
							<option value="2">Edit</option>
							<option value="0">None</option>
						    </select>
					...
					<fieldset>
						...
						<br/>
						<button class="btn btn-large btn-info" type="submit" style="box-shadow: 0px 2px 5px 2px grey;">Change Permissions</button>
					    </div>
					</fieldset>
				    </form>	
