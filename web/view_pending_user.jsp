		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">View Pending User</a>
					</li>
					...
					<% User c = UserComm.getPendUsers((String) request.getParameter("username")).get(0);%>
					<div class="box span6">
					    <div class="box-header well" data-original-title>
					...
					<jsp:include page='<%="accept_user.jsp"%>'/>
