...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
		    ...
		    <% Product p = ProdComm.getProducts((String) request.getParameter("prod_sn")).get(0);%>
...
%>
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">View Product</a>
					</li>
				    </ul>
					...
					<div class="box span5" style="margin-top:10%;">
						...
						<table class="table table-striped">
						    ...
						    <tr>
							<td class="my_table_headers">Serial Number :</td>
							<td ><%=p.getSerialN()%></td>
						    ...
						    <tr>
							<td class="my_table_headers">Category :</td>
							<td ><%=p.getCat()%></td>                                        
						    </tr>
						    <tr>
							<td class="my_table_headers">Weight :</td>
							<td ><%=p.getWeight()%></td>                                        
						    </tr>
						    <tr>
							<td class="my_table_headers">Dimensions :</td>
							<td ><%=p.getDim()%></td>                                        
						    </tr>                                
					...
					<div class="box span7">
					    <div class="box-header well" data-original-title>
						<h2>Warehouses where the product is kept</h2>
					    </div>
					    <div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						    ...
						    <tbody>
							<%List<Warehouse> warehouses = (List) request.getAttribute("warehouses");
							    List<Integer> quantities = (List) request.getAttribute("quantities");
							    ListIterator itr = warehouses.listIterator();
							    int n = 0;%>
							<% while (itr.hasNext()) {
								Warehouse w = (Warehouse) itr.next();
								n++;
							%>
							<tr>
							    <td><%=w.getName()%></td>
							    <td class="center"><%=w.getLocation()%></td>
							    <td class="center"><%=w.getDescription()%></td>
					...
					<div class="box span7">
					    <div class="box-header well" data-original-title>
						<h2>Suppliers of the product</h2>
					    </div>
					    <div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						    <thead>
							<tr>
							    <th>Name</th>
							    <th>Address</th>
							    <th style="width:145px;">National Ins. Number</th>
							    <th>Price</th>
							</tr>
						    </thead>   
						    <tbody>
							<%List<Supplier> suppliers = (List) request.getAttribute("suppliers");
							    List<String> prices = (List) request.getAttribute("prices");
							    ListIterator itr1 = suppliers.listIterator();
							    int n_n = 0;%>
							<% while (itr1.hasNext()) {
								Supplier s = (Supplier) itr1.next();
								n_n++;
							%>
							<tr>
							    <td><%=s.getName()%></td>
							    <td class="center"><%=s.getAddress()%></td>
							    <td class="center"><%=s.getN_i_n()%></td>
							    <td ><%=prices.get(n_n - 1)%></td>   
							</tr>
							<%}%>
						    </tbody>
						</table>
