		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Edit Warehouse</a>
					</li>
				    ...
				    <!--<div class="span6">-->
				    <form class="form-horizontal" action="wh_edit" method="post">
					<%@ page import="entities.Warehouse" %>
					<%@ page import="DBcomm.WhComm" %>

					<% Warehouse w =  WhComm.getWh(request.getParameter("wh_name")).get(0); %>
					<!--<input type="hidden" name="wh_name" value="<%//request.getParameter("wh_name");%>" />-->
					<!--fieldset for personal information--> 
					<fieldset style="float:left;">
					    <legend class=" my_legend">Warehouse Information</legend>
					    <!--Name field-->
					    <div class="control-group">
						<label class="control-label" for="focusedInput">Name</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="new_name" value="<%=w.getName()%>" readonly="readonly"/>
						    <input type="hidden" name="old_name" value="<%=w.getName()%>" />
						</div>
					    </div>
					    <!--Surname field-->
					    <div class="control-group">
						...
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="description" autofocus />
						</div>
					    </div>
					    <!--Username field-->
					    <div class="control-group">
						...
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name="location" />
						</div>
					    </div>
					...
					<fieldset>
					    <div class="span6" style="padding-top:10px; padding-bottom:10px; margin-left:33%; margin-top:16%;">
						<br/>
