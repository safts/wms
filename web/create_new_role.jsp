...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Create New Sytem Role</a>
					</li>
					...
					<h1>Create New System Role
					    <span class="my_back_button"><button class="btn btn-primary"><span title=".icon32  .icon-white  .icon-arrowthick-w " class="icon icon-white icon-arrowthick-w"></span><span>Back to "Manage Sytem Roles"</span></button></span>
				    ...
				    <!--<div class="span6">-->
				    <form class="form-horizontal" method="post" action="sys_role_add">
					<!--fieldset for personal information-->
					<div class="my_legend">System Role Information <i style="color:red; font-size:13px;"> ( Notice: All fields are required-marked with a ' * ' )</i></div>
					...
					<fieldset style="float:left;">
						...
						<label class="control-label" for="focusedInput">Role Description</label>
						<div class="controls">
						    <input id="description" name="description" class="input-xlarge focused" type="text" autofocus autocomplete="off" maxlength="45"/>
					    ...
					    <div class="control-group" style="width:650px;">
						<label class="control-label" for="selectError" style="width:150px;">
						    Warehouse Permissions
						</label>

						<div class="controls">
						    <select  data-rel="chosen" name="wh_sel">
							<option disabled="disabled" selected="selected" value="none">none</option>
							<option value="1">Read</option>
							<option value="2">Edit</option>
							<option value="0" selected="selected">None</option>
						    </select>
						    <span style="color:red; vertical-align:top;">*</span>
						    <span id="whpspan" style="vertical-align:super;"></span>
						</div>
					    </div>
						...
						<div class="controls">
						    <select  data-rel="chosen" name="suppl_sel">
							<option value="1">Read</option>
							<option value="2">Edit</option>
							<option value="0" selected="selected">None</option>
						    </select>
						    <span style="color:red; vertical-align:top;">*</span>
						    <span id="supspan" style="vertical-align:super;"></span>
						</div>
					    </div>
					    <div class="control-group" style="width:650px;">
						<label class="control-label" for="selectError">
						...
						<div class="controls">
						    <select   data-rel="chosen" name="pr_sel">
							<option value="1">Read</option>
							<option value="2">Edit</option>
							<option value="0" selected="selected">None</option>
						    </select>
						    <span style="color:red; vertical-align:top;">*</span>
						    <span id="prpspan" style="vertical-align:super;"></span>
						</div>
					    </div>
					    <div class="control-group" style="width:650px;">
						<label class="control-label" for="selectError">
						...
						<div class="controls">
						    <select  data-rel="chosen" name="rl_sel">
							<option value="1">Read</option>
							<option value="2">Edit</option>
							<option value="0" selected="selected">None</option>
						    </select>
						    <span style="color:red; vertical-align:top;">*</span>
						    <span id="ropspan" style="vertical-align:super;"></span>
						</div>
					    </div>
					    <div class="control-group" style="width:650px;">
						<label class="control-label" for="selectError">
						...
						<div class="controls">
						    <select  data-rel="chosen" name="usr_sel">
							<option value="1">Read</option>
							<option value="2">Edit</option>
							<option value="0" selected="selected">None</option>
						    </select>
						    <span style="color:red; vertical-align:top;">*</span>
						    <span id="uspspan" style="vertical-align:super;"></span>
						</div>
					    </div>
					</fieldset>
					<fieldset>
					    <div class="span6" style="padding-top:10px; padding-bottom:10px; margin-left:30%; margin-top:25%;">
						<br/>
						<button class="btn btn-large btn-info" type="submit" style="box-shadow: 0px 2px 5px 2px grey;">Insert Role</button>
					    </div>
					</fieldset>
				    </form>	
	...
	<script src="js/validate_new_role.js" type="text/javascript"></script>
