		...
		<div class="row-fluid"> <!--row-fluid gia left menu kai content-->
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
					    <span class="divider">/</span><a href="#">Edit Product Supplier</a>
					</li>
				    ...
				    <!--<div class="span6">-->
				    <form class="form-horizontal" method="post" action="suppl_edit">
					<!--fieldset for personal information-->
					<%@ page import="entities.Supplier" %>
					<%@ page import="DBcomm.SupplComm" %>

					<div class="my_legend">Product Supplier Information</div>
					<div style="border-bottom: 1px solid #e5e5e5;margin-bottom: 40px; margin-top:0px; width:44%;"></div> 
					<%Supplier s = SupplComm.getSuppliers((String) request.getParameter("name")).get(0);%>
					<fieldset style="float:left;">
					    <!--Name field-->
					    <div class="control-group" style="width:650px;">
						<label class="control-label" for="focusedInput">Name</label>
						<div class="controls">
						    <input id="focusedInput" class="input-xlarge focused" type="text" name ="name" value="<%=s.getName()%>" readonly="readonly"  />
						</div>
					    </div>
					    <!--Surname field-->
					    <div class="control-group" style="width:650px;">
						...
						<div class="controls">
						    <input id="address" class="input-xlarge focused" type="text" name="address" value="<%=s.getAddress()%>" autofocus />
						...
						<div class="controls">
						    <input id="email" class="input-xlarge focused" type="text" name="email" value="<%=s.getEmail()%>" />
							<span style="color:red;">*</span>
						...
						<div class="controls">
						    <input id="phone" class="input-xlarge focused" type="text" name="phone_n" value="<%=s.getPhone_number()%>" />
							<span style="color:red;">*</span>
						...
						<div class="controls">
						    <input id="nin" class="input-xlarge focused" type="text" name="nin" value="<%=s.getN_i_n()%>" />
							<span style="color:red;">*</span>
					...
					<fieldset>
						...
						<br/>
						<button class="btn btn-large btn-info" type="submit" style="box-shadow: 0px 2px 5px 2px grey;">Submit Changes</button>
					    </div>
					</fieldset>
				    </form>	
